#!/usr/bin/env python3
"""
PG Task Module - Pathological Gambling - 2 to 6 item scale (varies between questions).
...
class FTNDTask(BaseSurveyTask):
    ...
    DATA_FILE = "survey_data/promptsPgVaried.jsonl"
    TASK_NAME = "PG"
    ANSWER_RANGE = (0, 6)  
    
    def format_chat_text(self, text, tokenizer, entry_idx):
        """
        Custom formatting for PG which has:
