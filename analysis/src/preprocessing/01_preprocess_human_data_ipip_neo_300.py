...
Reads data/raw/ipipneo300_data/human_data/ (ipip20993.dat + IPIP-NEO-ItemKey.xls).
Writes data/intermediate/ipipneo300_data/human_data/ipipneo_human{,_raw}.csv.
"""
...
# ---------- Reading data ----------------------------------
# read neo-ipip data
neo_ipip_data = pd.read_csv("../../data/raw/ipipneo300_data/human_data/ipip20993.dat", sep="\t")
...
neo_ipip_data_long_raw.to_csv('../../data/intermediate/ipipneo300_data/human_data/ipipneo_human_raw.csv', index=False)
neo_ipip_data_long.to_csv('../../data/intermediate/ipipneo300_data/human_data/ipipneo_human.csv', index=False)
